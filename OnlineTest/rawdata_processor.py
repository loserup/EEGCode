...
eeg_data = sio.loadmat('RawEEG.mat')['rawEEG']
gait_data = sio.loadmat('RawMotion.mat')['rawMotion']
...
sio.savemat('CutedEEG.mat', {'CutedEEG' : eeg_data})
sio.savemat('FilteredMotion.mat', {'FilteredMotion' : gait_data})
